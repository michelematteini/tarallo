// Original author: Bernardo Castilho
// github.com/Bernardo-Castilho/dragdroptouch/
let DragDropTouch;
    ...
    let DragDropTouch = (function () {
        ...
        DragDropTouch.prototype._touchend = function (e) {
            if (this._shouldHandle(e)) {
                ...
                if (!this._img) {
                    this._dragSource = null;
                    // this._dispatchEvent(this._lastTouch, 'click', e.target); // MOD FROM ORIGINAL: this click is not really needed, just duplicate the onclick
